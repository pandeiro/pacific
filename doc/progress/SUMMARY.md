...
[Card 23a] LLM Prompt Engineering — Tested 16 prompt/temperature variations with llama3.2:1b. Updated scraper/llm.py with optimal prompts (temp 0.0, simple system message, inline schema). Documented findings in doc/ref/llm_prompts.md.
